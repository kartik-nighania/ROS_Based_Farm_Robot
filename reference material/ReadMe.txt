...
other material used for this project consists of reference material used by different repositories that have been successfully forked into github.com/kartik-nighania.
the pulisher and subscriber that makes two nodes and start the communication process, instructions were taken from six_wheel_robot repo
